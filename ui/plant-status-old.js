...
function updateNotebookDisplay(plantData) {
    ...
    // Update plant image
    if (plantImage && plantData.plantName) {
        const imageUrl = `https://cfx-nui-vorp_inventory/html/img/items/${plantData.plantName.toLowerCase()}.png`;
...
function updateNotesSection(plantData) {
    ...
    // Add status-based notes (without accents)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Original: "Irrigação" -> Cleaned:', removeAccents('Irrigação'));
    console.log('Original: "Fertilizante Básico" -> Cleaned:', removeAccents('Fertilizante Básico'));
});

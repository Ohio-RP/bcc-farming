Plants = {
    ...
    -----------------------------------------------------
    {
        ...
        plantOffset = 1,                         -- If the plant is not on the ground properly you can use this setting
        jobLocked = false, 
smelling = false,                       -- If true, only players with the job will be able to harvest the plant
        smelling = false,                  -- PoliceJob can smell this plant
        blips = {
            enabled = true,                      -- Set true to Enable Blips for Plants (Only shows to planter)
            sprite = 'blip_mp_spawnpoint',       -- Default: 'blip_mp_spawnpoint'
...
smelling = false,                   -- If true, only players with the job will be able to harvest the plant
        blips = {
            enabled = true,                  -- Set true to Enable Blips for Plants (Only shows to planter)
            sprite = 'blip_mp_spawnpoint',   -- Default: 'blip_mp_spawnpoint'
            name = 'Blood Flower',           -- Name of Blip on Map
            color = 'WHITE'                  -- Blip Colors Shown in 'config.lua'
        },
        rewards = {
            {
                itemName = 'Blood_Flower',
                itemLabel = 'Blood Flower',
                amount = 1
            }
        },
        jobs = {
...
smelling = false,                    -- If true, only players with the job will be able to harvest the plant
        blips = {
            enabled = true,                   -- Set true to Enable Blips for Plants (Only shows to planter)
            sprite = 'blip_mp_spawnpoint',    -- Default: 'blip_mp_spawnpoint'
            name = 'Chanterelles',            -- Name of Blip on Map
            color = 'WHITE'                   -- Blip Colors Shown in 'config.lua'
        },
        rewards = {
            {
                itemName = 'Chanterelles',
                itemLabel = 'Chanterelles',
                amount = 1
            }
        },
        jobs = {
...
smelling = false,                  -- If true, only players with the job will be able to harvest the plant
        blips = {
            enabled = true,                 -- Set true to Enable Blips for Plants (Only shows to planter)
            sprite = 'blip_mp_spawnpoint',  -- Default: 'blip_mp_spawnpoint'
            name = 'Desert Sage',           -- Name of Blip on Map
            color = 'WHITE'                 -- Blip Colors Shown in 'config.lua'
        },
        rewards = {
            {
                itemName = 'Desert_Sage',
                itemLabel = 'Desert Sage',
                amount = 1
            }
        },
        jobs = {
...
smelling = false,                       -- If true, only players with the job will be able to harvest the plant
        blips = {
            enabled = true,                      -- Set true to Enable Blips for Plants (Only shows to planter)
            sprite = 'blip_mp_spawnpoint',       -- Default: 'blip_mp_spawnpoint'
            name = 'Evergreen Huckleberry',      -- Name of Blip on Map
            color = 'WHITE'                      -- Blip Colors Shown in 'config.lua'
        },
        rewards = {
            {
                itemName = 'Evergreen_Huckleberry',
                itemLabel = 'Evergreen Huckleberry',
                amount = 1
            }
        },
        jobs = {
    ...
    -----------------------------------------------------
    {
        ...
        blips = {
            enabled = true,                -- Set true to Enable Blips for Plants (Only shows to planter)
            sprite = 'blip_mp_spawnpoint', -- Default: 'blip_mp_spawnpoint'
            name = 'Golden Currant',       -- Name of Blip on Map
            color = 'WHITE'                -- Blip Colors Shown in 'config.lua'
        },
        rewards = {
            {
                itemName = 'Golden_Currant',
                itemLabel = 'Golden Currant',
                amount = 1
            }
        },
        jobs = {
